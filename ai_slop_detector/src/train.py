...
class Trainer:
    ...
    def train_episode(self, dataset: List[Tuple[str, int]]) -> Tuple[float, float]:
        episode_reward = 0.0
        episode_loss = 0.0
        correct = 0
    ...
    def train(self, train_data: List[Tuple[str, int]], 
        ...
        for episode in range(num_episodes):
            ...
            if episode % 10 == 0:
                print(f"Episode {episode}: train_acc={train_acc:.3f}, val_acc={val_acc:.3f}, eps={self.agent.epsilon:.3f}")
